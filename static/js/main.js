...
import { LeaguesModule } from './modules/leagues.js?v=44';
import { TeamsModule } from './modules/teams.js?v=44';
import { PlayersModule } from './modules/players.js?v=44';
import { FinanceModule } from './modules/finance.js?v=44';
import { ArbitrosModule } from './modules/arbitros.js';
import { DashboardModule } from './modules/dashboard.js';
import EntrenamientosModule from './modules/entrenamientos.js?v=44';
